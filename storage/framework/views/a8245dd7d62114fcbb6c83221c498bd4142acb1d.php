...
<div class="product-model">	 
	 <div class="container">
		 ...
		 <div class="col-md-9 product-model-sec">
					 ...
					 <a href="<?php echo e(route('single' , [$product->id])); ?>"><div class="product-grid love-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="<?php echo e(asset('public/images/' . $product->image)); ?>" class="img-responsive" alt=""/>
							<div class="b-wrapper">
					 ...
					 <div class="product_right">
						 ...
						 <div class="tab1">
							 <ul class="place">								
								 ...
								 <li class="by"><img src="<?php echo e(asset('public/images/do.png')); ?>" alt=""></li>
									<div class="clearfix"> </div>
							  </ul>
...
<?php echo $__env->make('shop.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel-workshop/resources/views/shop/women.blade.php ENDPATH**/ ?>