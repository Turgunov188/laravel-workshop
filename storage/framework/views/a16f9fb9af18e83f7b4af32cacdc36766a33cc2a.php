...
<div class="about">
	 <div class="container">
		 ...
		 <h2>ABOUT US</h2>
		 <div class="about-sec">
			 <div class="about-pic"><img src="<?php echo e(asset('public/images/a1.jpg')); ?>" class="img-responsive" alt=""/></div>
		 ...
		 <div class="about-grids">
			 <div class="col-md-3 about-grid">
				 <img src="<?php echo e(asset('public/images/ab1.jpg')); ?>" class="img-responsive" alt=""/>
			 ...
			 <div class="col-md-3 about-grid">
				 <img src="<?php echo e(asset('public/images/ab2.jpg')); ?>" class="img-responsive" alt=""/>
				 <a href="blog-single.html"><h4>Salwars</h4></a>
				 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus, recusandae, minima deserunt pariatur illo eos doloremque 
				 Asperiores modi temporibus consequuntur tempore quibusdam!</p>
			 </div>
			 <div class="col-md-3 about-grid pot-2">
				 <img src="<?php echo e(asset('public/images/ab3.jpg')); ?>" class="img-responsive" alt=""/>
				 <a href="blog-single.html"><h4>Desi Look</h4></a>
				 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus, recusandae, minima deserunt pariatur illo eos doloremque
				 Asperiores modi temporibus consequuntur tempore quibusdam!</p>
			 </div>
			 <div class="col-md-3 about-grid pot-1">
				 <img src="<?php echo e(asset('public/images/ab4.jpg')); ?>" class="img-responsive" alt=""/>
			 ...
			 <div class="col-md-3 about-grid flwr">
				 <img src="<?php echo e(asset('public/images/ab5.jpg')); ?>" class="img-responsive" alt=""/>
				 <a href="blog-single.html"><h4>NEWLOOK</h4></a>
				 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus, recusandae, minima deserunt pariatur illo eos doloremque
				 Asperiores modi temporibus consequuntur tempore quibusdam!</p>
			 </div>
			 <div class="col-md-3 about-grid flwr">
				 <img src="<?php echo e(asset('public/images/ab6.jpg')); ?>" class="img-responsive" alt=""/>
				 <a href="blog-single.html"><h4>Meriea</h4></a>
				 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus, recusandae, minima deserunt pariatur illo eos doloremque 
				 Asperiores modi temporibus consequuntur tempore quibusdam!</p>
			 </div>
			 <div class="col-md-3 about-grid flwr pot-2">
				 <img src="<?php echo e(asset('public/images/ab7.jpg')); ?>" class="img-responsive" alt=""/>
				 <a href="blog-single.html"><h4>Woolen Shurg</h4></a>
				 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus, recusandae, minima deserunt pariatur illo eos doloremque
				 Asperiores modi temporibus consequuntur tempore quibusdam!</p>
			 </div>
			 <div class="col-md-3 about-grid flwr pot-1">
				 <img src="<?php echo e(asset('public/images/ab8.jpg')); ?>" class="img-responsive" alt=""/>
...
<?php echo $__env->make('shop.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel-workshop/resources/views/shop/about.blade.php ENDPATH**/ ?>